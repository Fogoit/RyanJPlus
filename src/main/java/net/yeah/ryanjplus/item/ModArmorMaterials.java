...
public enum ModArmorMaterials implements ArmorMaterial {
    RYAN("ryan",9,new int[]{ 2, 6, 5, 2 },2,
            SoundEvents.CREEPER_PRIMED,-5f,1.0f,() -> Ingredient.of(RDworskyMod.RYAN_DWORSKY_BLOCK_ITEM.get())),
    COOL("cool",9,new int[]{ 1, 1, 1, 1 },0,
            SoundEvents.ARMOR_EQUIP_LEATHER,0f,0f,() -> Ingredient.of(Items.TINTED_GLASS));
    ...
    public String getName() {
        return RyanJPlus.MOD_ID + ":" + this.name;
    }
